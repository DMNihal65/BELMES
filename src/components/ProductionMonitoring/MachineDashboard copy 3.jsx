  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="p-6 space-y-6">
        ...
        {/* Machine Status Summary - Improved Version */}
        <Card className="shadow-sm mb-4">
          <div className="flex flex-wrap items-center justify-between">
            {/* Status Indicators */}
            <div className="flex items-center gap-4">
              <div className="flex items-center">
                <div className="flex flex-col items-center justify-center bg-gradient-to-r from-green-50 to-green-100 p-3 rounded-lg">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-green-500"></div>
                    <span className="text-sm font-medium">Production</span>
                  </div>
                  <span className="text-xl font-bold text-green-600">{stats.production}</span>
                </div>
              </div>
              
              <div className="flex items-center">
                <div className="flex flex-col items-center justify-center bg-gradient-to-r from-yellow-50 to-yellow-100 p-3 rounded-lg">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                    <span className="text-sm font-medium">Idle</span>
                  </div>
                  <span className="text-xl font-bold text-yellow-600">{stats.on + stats.idle}</span>
                </div>
              </div>
              
              <div className="flex items-center">
                <div className="flex flex-col items-center justify-center bg-gradient-to-r from-gray-50 to-gray-100 p-3 rounded-lg">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-gray-500"></div>
                    <span className="text-sm font-medium">Offline</span>
                  </div>
                  <span className="text-xl font-bold text-gray-600">{stats.off + stats.offline}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 pr-2">
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm text-gray-600">Total<br/>Machines</div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm text-gray-600">Active<br/>Jobs</div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm text-gray-600">
                  Updated<br/>
                  <span className="font-medium">{overallOEEMetrics?.lastUpdated ? dayjs(overallOEEMetrics.lastUpdated).format('HH:mm') : '--:--'}</span>
                </div>
              </div>
            </div>
          </div>
