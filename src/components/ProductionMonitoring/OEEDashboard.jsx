...
const OEEDashboard = () => {
  ...
  try {
    ...
    const response = await axios.get(
      `http://172.18.7.89:5469/production_monitoring/overall-oee-analytics/?${params.toString()}`
    );
  ...
  //     const response = await axios.get(
  //       `http://172.18.7.89:5469/production_monitoring/detailed-shift-summary/?${params.toString()}`
  //     );
  ...
  //       axios.get(`http://172.18.7.89:5469/production_monitoring/machine-oee-analysis/${id}?start_date=${formattedStartDate}&end_date=${formattedEndDate}`)
  //     );
  ...
  try {
    ...
    const promises = machineIds.map(id => {
      ...
      return axios.get(`http://172.18.7.89:5469/production_monitoring/machine-oee-analysis/${id}?${params.toString()}`);
    });
  ...
  //     const response = await axios.get(
  //       `http://172.18.7.89:5469/production_monitoring/machine-oee-analysis/${machineId}?start_date=${formattedStartDate}&end_date=${formattedEndDate}`
  //     );
  ...
  try {
    ...
    const response = await axios.get(
      `http://172.18.7.89:5469/production_monitoring/machine-oee-analysis/${machineId}?${params.toString()}`
    );
