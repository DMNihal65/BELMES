...
import { ZoomIn, ZoomOut, Maximize, RefreshCw, Calendar, List } from 'lucide-react';
      ...
      const items = data.map((item, index) => ({
        ...
        content: `
          <div class="timeline-item ${item.type}-item">
            <div class="item-header">${item.component || 'No Component'}</div>
        ...
        title: `
          <div class="tooltip-content">
            <div class="tooltip-header">${item.type.toUpperCase()}</div>
        ...
        className: `${item.type}-item ${item.status ? item.status.toLowerCase() : ''}`
      }));
