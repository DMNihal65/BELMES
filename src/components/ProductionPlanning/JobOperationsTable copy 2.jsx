      ...
      render: (text, record) => {
        ...
        if (editable) {
          ...
          return (
            ...
            >
              <Select 
                open={true}  // Force dropdown to be open
                style={{ 
                  width: '100%',
                  position: 'relative'  // Ensure proper stacking
                }}
                popupClassName="machine-select-dropdown"  // Add custom class for styling
                dropdownStyle={{ 
                  zIndex: 9999,  // Ensure dropdown appears above other elements
                  minWidth: '200px',  // Give enough width for content
                  padding: '8px 0'
                }}
                placeholder="Select machine"
                defaultActiveFirstOption={true}
                defaultValue={record.primary_machine?.name}
        ...
        return record.primary_machine?.name || '-';
      }
    },
    {
      title: 'Actions',
