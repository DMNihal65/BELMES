...
function Sidebar() {
  ...
  const notificationStyle = {
    backgroundImage: `url('${baseUrl}images/notification.jpg')`,
  ...
  return (
    <div className="h-screen flex flex-col">
      <style jsx global>{`
        ...
        .dashboard-menu-item {
          background-image: url('${baseUrl}images/dashboard.jpg');
        }
        .quality-menu-item {
          background-image: url('${baseUrl}images/quality.jpg');
        }
        .maintenance-menu-item {
          background-image: url('${baseUrl}images/manintance.jpg');
          background-position: center 30%;
        }
        .energy-menu-item {
          background-image: url('${baseUrl}images/energy_mon.jpg');
          background-position: center 30%;
        }
        .documents-menu-item {
          background-image: url('${baseUrl}images/document_mang.jpg');
          background-position: center 30%;
        }
        .access-control-menu-item {
          background-image: url('${baseUrl}images/access.jpg');
          background-position: center 30%;
        }
        .process-engineering-header {
          background-image: url('${baseUrl}images/planning.jpg');
        ...
        .inventory-menu-header {
          background-image: url('${baseUrl}images/inventory.jpg');
          background-position: center center;
          background-size: cover;
          height: 100px;
          display: flex;
        ...
        .help-support-item {
          background-image: url('${baseUrl}images/help.jpg');
          background-position: center center;
          background-size: cover;
          height: 100px !important;
          margin: 8px !important;
        ...
        .production-monitoring-header {
          background-image: url('${baseUrl}images/production.jpg');
          background-position: center center;
          background-size: cover;
          height: 100px;
          display: flex;
        ...
        .order-management-item > .ant-menu-submenu-title {
          background-image: url('${baseUrl}images/ordermanagment.jpg') !important;
...
.notification-menu-item {
  background-image: url('${baseUrl}images/notification.jpg') !important;
  background-position: center center !important;
  background-size: cover !important;
  height: 100px !important;
  margin: 8px !important;
