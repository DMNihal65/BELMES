...
const MachinePasswordManagement = ({ onClose }) => {
  ...
  //       "http://127.0.0.1:8000/api/v1/master-order/all-machines/"
  //     );
  ...
  const onFinish = async (values) => {
    ...
    try {
      const response = await axios.post(
        `http://127.0.0.1:8000/api/v1/auth/register-machine-password?machine_id=${machineName}&password=${password}`
      );
