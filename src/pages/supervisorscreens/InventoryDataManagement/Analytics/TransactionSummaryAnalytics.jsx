  ...
  const fetchAnalytics = async () => {
    try {
      ...
      const [requestsRes, summaryRes, metricsRes, historyRes] = await Promise.all([
        axios.get('http://172.18.7.88:7599/api/v1/api/inventory/analytics/requests-by-status'),
        axios.get('http://172.18.7.88:7599/api/v1/api/inventory/analytics/transaction-summary'),
        axios.get('http://172.18.7.88:7599/api/v1/api/inventory/analytics/transaction-metrics'),
        axios.get('http://172.18.7.88:7599/api/v1/api/inventory/analytics/transaction-history?limit=100&offset=0')
      ]);
