  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <Col span={4}>
        <Card bodyStyle={{ padding: '20px' }}>
          <Space direction="vertical" size={0}>
            <div className="text-sm text-pale-sky-500">Total Tools</div>
            <Space align="center" className="mt-2">
              <span className="text-2xl font-semibold">
                {summaryData.totalTools.toLocaleString()}
              </span>
              <ToolOutlined className="text-2xl text-sky-500 bg-sky-50 p-2 rounded-lg" />
            </Space>
            <Space align="center" className="mt-2 text-sky-500">
              <ArrowUpOutlined />
              <span>{summaryData.totalToolsChange}% {summaryData.totalToolsPeriod}</span>
            </Space>
          </Space>
        </Card>
      </Col>
      <Col span={4}>
          <Card bodyStyle={{ padding: '20px' }}>
              <Space direction="vertical" size={0}>
                  <div className="text-sm text-pale-sky-500">Available Tools</div>
                  <Space align="center" className="mt-2">
                  <span className="text-2xl font-semibold">
                          {summaryData.availableTools.toLocaleString()}
                      </span>
                      <CheckCircleOutlined className="text-2xl text-sky-500 bg-sky-50 p-2 rounded-lg" />
                  </Space>
                  <Space align="center" className="mt-2 text-sky-500">
                      <ArrowUpOutlined />
                      <span>{summaryData.availableToolsChange}% {summaryData.availableToolsPeriod}</span>
                  </Space>
              </Space>
          </Card>
      </Col>
