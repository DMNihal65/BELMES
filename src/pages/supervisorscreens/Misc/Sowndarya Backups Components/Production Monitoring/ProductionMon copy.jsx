...
const MachineScheduleChart = () => {
  const machines = ['MMC1', 'CNCM', 'SMPD'];
  ...
  useEffect(() => {
    const filteredMachines = selectedMachines.includes('all') ? machines : selectedMachines;
...
export default MachineScheduleChart;