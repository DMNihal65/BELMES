...
const preloadLocalFonts = () => {
  ...
  style.textContent = `
    @font-face {
      font-family: 'Inter';
      src: url('${baseUrl}fonts/Rubik-VariableFont_wght.ttf') format('truetype');
      font-weight: normal;
      font-style: normal;
      font-display: swap;
    }
    @font-face {
      ...
      src: url('${baseUrl}fonts/Rubik-Italic-VariableFont_wght.ttf') format('truetype');
      font-weight: normal;
      font-style: italic;
      font-display: swap;
    }
  ...
  // Preload font files
  const fontFiles = [
    `${baseUrl}fonts/Rubik-VariableFont_wght.ttf`,
    `${baseUrl}fonts/Rubik-Italic-VariableFont_wght.ttf`
  ];
...
const preloadEnvironmentMaps = () => {
  const baseUrl = import.meta.env.BASE_URL;
  const hdrFiles = [
    `${baseUrl}machine_shop_02_4k.hdr`,
    `${baseUrl}warehouse.hdr`
  ];
