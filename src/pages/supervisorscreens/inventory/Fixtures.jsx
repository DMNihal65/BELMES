...
const columns = [
  ...
  },
  {
    ...
    filterSearch: true,
    filters: [...new Set(FixturesData.map(item => item.quantity))].map(item => ({ text: item, value: item })),
  ...
  },
  {
    ...
    filterSearch: true,
    filters: [...new Set(FixturesData.map(item => item.status))].map(item => ({ text: item, value: item })),
