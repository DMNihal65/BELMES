...
const useDocumentStore = create((set, get) => ({
  ...
  fetchDocTypes: async () => {
    ...
    try {
      ...
      const response = await fetch('http://172.18.7.85:2088/api/v1/document-management/document-types/', {
        headers: {
  ...
  fetchFolders: async (parentId = null) => {
    ...
    try {
      ...
      const url = parentId 
        ? `http://172.18.7.85:2088/api/v1/document-management/folders/?parent_id=${parentId}`
        : 'http://172.18.7.85:2088/api/v1/document-management/folders/';
  ...
  uploadDocument: async (formData) => {
    try {
      ...
      const response = await fetch('http://172.18.7.85:2088/api/v1/document-management/documents/upload/', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  fetchFolderDocuments: async (folderId, page = 1, pageSize = 10) => {
    try {
      ...
      const response = await fetch(
        `http://172.18.7.85:2088/api/v1/document-management/documents/?folder_id=${folderId}&page=${page}&page_size=${pageSize}`,
        {
          headers: {
            'Authorization': `Bearer ${token}`,
            'Accept': 'application/json'
  ...
  updateFolder: async (folderId, updateData) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.85:2088/api/v1/documents/folders/${folderId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json',
  ...
  searchDocuments: async (query, docTypeId = null, folderId = null) => {
    try {
      ...
      let url = `http://172.18.7.85:2088/api/v1/document-management/documents/search/?query=${encodeURIComponent(query)}`;
  ...
  searchByPartNumber: async (partNumber, docTypeId = null) => {
    try {
      ...
      let url = `http://172.18.7.85:2088/api/v1/document-management/documents/by-part-number/${encodeURIComponent(partNumber)}`;
      if (docTypeId) {
  ...
  downloadDocumentVersion: async (documentId, versionId = null) => {
    try {
      ...
      const url = versionId 
        ? `http://172.18.7.85:2088/api/v1/document-management/documents/${documentId}/download?version_id=${versionId}`
        : `http://172.18.7.85:2088/api/v1/document-management/documents/${documentId}/download-latest`;
  ...
  fetchDocumentVersions: async (documentId) => {
    try {
      ...
      const response = await fetch(
        `http://172.18.7.85:2088/api/v1/document-management/documents/${documentId}/versions`,
        {
          headers: {
            'Authorization': `Bearer ${token}`,
            'accept': 'application/json'
  ...
  deleteFolder: async (folderId) => {
    try {
      ...
      console.log('Making DELETE request to:', `http://172.18.7.85:2088/api/v1/documents/folders/${folderId}`);
  ...
  copyDocument: async (copyData) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.85:2088/api/v1/documents/${copyData.document_id}/copy`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json',
  ...
  updateVersion: async (documentId, versionId, file, metadata = {}) => {
    try {
      ...
      const response = await fetch(
        `http://172.18.7.85:2088/api/v1/document-management/documents/${documentId}/version/${versionId}`,
        {
          method: 'PUT',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  deleteVersion: async (documentId, versionId) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.85:2088/api/v1/documents/${documentId}/versions/${versionId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
  ...
  incrementDownloadCount: async (documentId) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.85:2088/api/v1/documents/${documentId}/download-count`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  incrementViewCount: async (documentId) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.85:2088/api/v1/documents/${documentId}/view-count`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  createFolder: async (folderData) => {
    try {
      ...
      const response = await fetch('http://172.18.7.85:2088/api/v1/document-management/folders/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  searchByProductionOrder: async (productionOrderId, docTypeId = null) => {
    try {
      ...
      let url = `http://172.18.7.85:2088/api/v1/document-management/documents/by-production-order/${productionOrderId}`;
      if (docTypeId) {
        url += `?doc_type_id=${docTypeId}`;
      }
