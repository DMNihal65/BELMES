...
const useDocumentStore = create((set, get) => ({
  ...
  fetchDocTypes: async () => {
    ...
    try {
      ...
      const response = await fetch('http://172.18.7.88:4493/api/v1/document-management/document-types/', {
        headers: {
  ...
  updateFolder: async (folderId, updateData) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.88:4493/api/v1/documents/folders/${folderId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json',
  ...
  deleteFolder: async (folderId) => {
    try {
      ...
      console.log('Making DELETE request to:', `http://172.18.7.88:4493/api/v1/documents/folders/${folderId}`);
  ...
  copyDocument: async (copyData) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.88:4493/api/v1/documents/${copyData.document_id}/copy`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json',
  ...
  deleteVersion: async (documentId, versionId) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.88:4493/api/v1/documents/${documentId}/versions/${versionId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
