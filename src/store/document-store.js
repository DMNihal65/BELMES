...
const useDocumentStore = create((set, get) => ({
  ...
  fetchDocTypes: async () => {
    ...
    try {
      const response = await makeApiRequest('http://127.0.0.1:8000/api/v1/document-management/document-types/');
  ...
  fetchFolders: async (parentId = null) => {
    ...
    try {
      const url = parentId 
        ? `http://127.0.0.1:8000/api/v1/document-management/folders/?parent_id=${parentId}`
        : 'http://127.0.0.1:8000/api/v1/document-management/folders/';
  ...
  fetchPartNumbers: async () => {
    try {
      const response = await makeApiRequest('http://127.0.0.1:8000/api/v1/planning/all_orders');
      const data = await response.json();
  ...
  uploadDocument: async (formData) => {
    try {
      ...
      const response = await fetch('http://127.0.0.1:8000/api/v1/document-management/documents/upload/', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  fetchFolderDocuments: async (folderId) => {
    ...
    try {
      ...
      const response = await makeApiRequest(
        `http://127.0.0.1:8000/api/v1/document-management/documents/?folder_id=${folderId}`
      );
  ...
  deleteDocument: async (documentId) => {
    ...
    try {
      ...
      const response = await fetch(`http://127.0.0.1:8000/api/v1/document-management/documents/${documentId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
  ...
  updateFolder: async (folderId, updateData) => {
    try {
      const response = await makeApiRequest(`http://127.0.0.1:8000/api/v1/documents/folders/${folderId}`, {
        method: 'PUT',
        body: JSON.stringify({
  ...
  searchDocuments: async (query, docTypeId = null, folderId = null) => {
    ...
    try {
      ...
      let url = `http://127.0.0.1:8000/api/v1/document-management/documents/search/?query=${encodeURIComponent(query)}`;
  ...
  searchByPartNumber: async (partNumber, docTypeId = null) => {
    ...
    try {
      ...
      let url = `http://127.0.0.1:8000/api/v1/document-management/documents/by-part-number/${encodeURIComponent(partNumber)}`;
      if (docTypeId) {
  ...
  downloadDocumentVersion: async (documentId, versionId = null) => {
    try {
      ...
      const url = versionId 
        ? `http://127.0.0.1:8000/api/v1/document-management/documents/${documentId}/download?version_id=${versionId}`
        : `http://127.0.0.1:8000/api/v1/document-management/documents/${documentId}/download-latest`;
  ...
  fetchDocumentVersions: async (documentId) => {
    try {
      const response = await makeApiRequest(
        `http://127.0.0.1:8000/api/v1/document-management/documents/${documentId}/versions`
      );
  ...
  deleteFolder: async (folderId) => {
    try {
      const response = await makeApiRequest(`http://127.0.0.1:8000/api/v1/document-management/folders/${folderId}`, {
        method: 'DELETE'
      });
  ...
  copyDocument: async (copyData) => {
    try {
      const response = await makeApiRequest(`http://127.0.0.1:8000/api/v1/documents/${copyData.document_id}/copy`, {
        method: 'POST',
        body: JSON.stringify({
  ...
  updateVersion: async (documentId, versionId, file, metadata = {}) => {
    try {
      ...
      const response = await fetch(
        `http://127.0.0.1:8000/api/v1/document-management/documents/${documentId}/version/${versionId}`,
        {
          method: 'PUT',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  deleteVersion: async (documentId, versionId) => {
    try {
      ...
      const response = await fetch(`http://127.0.0.1:8000/api/v1/document-management/documents/${documentId}/versions/${versionId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
  ...
  incrementDownloadCount: async (documentId) => {
    try {
      ...
      const response = await fetch(`http://127.0.0.1:8000/api/v1/documents/${documentId}/download-count`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  incrementViewCount: async (documentId) => {
    try {
      ...
      const response = await fetch(`http://127.0.0.1:8000/api/v1/documents/${documentId}/view-count`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  createFolder: async (folderData) => {
    try {
      ...
      const response = await fetch('http://127.0.0.1:8000/api/v1/document-management/folders/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  searchByProductionOrder: async (productionOrderId, docTypeId = null) => {
    ...
    try {
      ...
      let url = `http://127.0.0.1:8000/api/v1/document-management/documents/by-production-order/${productionOrderId}`;
      if (docTypeId) {
        url += `?doc_type_id=${docTypeId}`;
      }
  ...
  downloadDocument: async (documentId, versionId = null) => {
    try {
      ...
      const url = `http://127.0.0.1:8000/api/v1/document-management/documents/${documentId}/download?version_id=${versionId}`;
  ...
  uploadMachineDocument: async (formData) => {
    try {
      ...
      const response = await fetch('http://127.0.0.1:8000/api/v1/document-management/machine-documents/upload/', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  fetchMachines: async () => {
    try {
      ...
      const response = await fetch('http://127.0.0.1:8000/api/v1/master-order/machines/', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Accept': 'application/json'
        }
  ...
  deleteDocumentVersion: async (versionId) => {
    try {
      ...
      const response = await fetch(`http://127.0.0.1:8000/api/v1/document-management/document-versions/${versionId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
  ...
  deleteDocumentType: async (docTypeId, force = false) => {
    try {
      ...
      const response = await fetch(`http://127.0.0.1:8000/api/v1/document-management/document-types/${docTypeId}?force=${force}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
  ...
  fetchMetrics: async () => {
    ...
    try {
      const response = await makeApiRequest('http://127.0.0.1:8000/api/v1/document-management/metrics/');
      const data = await response.json();
  ...
  fetchAnalytics: async () => {
    ...
    try {
      ...
      const response = await fetch('http://127.0.0.1:8000/api/v1/document-management/documents/analytics', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Accept': 'application/json'
        }
