...
const useDocumentStore = create((set, get) => ({
  ...
  fetchDocTypes: async () => {
    ...
    try {
      const response = await makeApiRequest('http://172.16.0.203:8002/api/v1/document-management/document-types/');
  ...
  fetchPartNumbers: async () => {
    try {
      const response = await makeApiRequest('http://172.16.0.203:8002/api/v1/planning/all_orders');
      const data = await response.json();
  ...
  fetchFolderDocuments: async (folderId) => {
    ...
    try {
      ...
      const response = await makeApiRequest(
        `http://172.16.0.203:8002/api/v1/document-management/documents/?folder_id=${folderId}`
      );
  ...
  deleteDocument: async (documentId) => {
    ...
    try {
      ...
      const response = await fetch(`http://172.16.0.203:8002/api/v1/document-management/documents/${documentId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
  ...
  updateFolder: async (folderId, updateData) => {
    try {
      const response = await makeApiRequest(`http://172.16.0.203:8002/api/v1/documents/folders/${folderId}`, {
        method: 'PUT',
        body: JSON.stringify({
  ...
  deleteFolder: async (folderId) => {
    try {
      const response = await makeApiRequest(`http://172.16.0.203:8002/api/v1/document-management/folders/${folderId}`, {
        method: 'DELETE'
      });
  ...
  copyDocument: async (copyData) => {
    try {
      const response = await makeApiRequest(`http://172.16.0.203:8002/api/v1/documents/${copyData.document_id}/copy`, {
        method: 'POST',
        body: JSON.stringify({
  ...
  deleteVersion: async (documentId, versionId) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.203:8002/api/v1/document-management/documents/${documentId}/versions/${versionId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
  ...
  fetchMetrics: async () => {
    ...
    try {
      const response = await makeApiRequest('http://172.16.0.203:8002/api/v1/document-management/metrics/');
      const data = await response.json();
  ...
  fetchAnalytics: async () => {
    ...
    try {
      ...
      const response = await fetch('http://172.16.0.203:8002/api/v1/document-management/documents/analytics', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Accept': 'application/json'
        }
