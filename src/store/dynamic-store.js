...
const useDynamicStore = create((set) => ({
  ...
  fetchPDCData: async () => {
    try {
      const response = await axios.get('http://172.18.7.85:9078/api/v1/rescheduling/part-production-pdc');
  ...
  //     const response = await fetch('http://172.18.7.85:9078/planning/all_orders', {
  //       headers: {
