...
const useDynamicStore = create((set) => ({
  ...
  fetchPDCData: async () => {
    try {
      const response = await axios.get('http://127.0.0.1:8000/api/v1/scheduling/part-production-pdc');
  ...
  //     const response = await fetch('http://127.0.0.1:8000/planning/all_orders', {
  //       headers: {
