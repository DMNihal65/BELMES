...
const useDynamicStore = create((set) => ({
  ...
  fetchPDCData: async () => {
    try {
      const response = await axios.get('http://172.18.7.89:8008/api/v1/scheduling/part-production-pdc');
  ...
  //     const response = await fetch('http://172.18.7.89:8008/planning/all_orders', {
  //       headers: {
