...
const useDynamicStore = create((set) => ({
  ...
  fetchPDCData: async () => {
    try {
      const response = await axios.get('http://172.16.0.229:1292/api/v1/scheduling/part-production-pdc');
  ...
  //     const response = await fetch('http://172.16.0.229:1292/planning/all_orders', {
  //       headers: {
