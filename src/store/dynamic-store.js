...
const useDynamicStore = create((set) => ({
  ...
  fetchPDCData: async () => {
    try {
      const response = await axios.get('http://172.17.80.1:6655/api/v1/scheduling/part-production-pdc');
  ...
  //     const response = await fetch('http://172.17.80.1:6655/planning/all_orders', {
  //       headers: {
