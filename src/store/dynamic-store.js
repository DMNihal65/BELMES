...
const useDynamicStore = create((set) => ({
  ...
  fetchPDCData: async () => {
    try {
      const response = await axios.get('http://172.18.7.88:2929/api/v1/scheduling/part-production-pdc');
  ...
  //     const response = await fetch('http://172.18.7.88:2929/planning/all_orders', {
  //       headers: {
