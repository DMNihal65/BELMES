...
const WS_MACHINES_ENDPOINT = 'ws://172.18.7.88:5458/api/v1/energymonitoring/ws/machines_data';

// Update the WebSocket endpoint for shiftwise energy data
const WS_SHIFTWISE_ENERGY_ENDPOINT = 'ws://172.18.7.88:5458/api/v1/energymonitoring/ws/shiftwise_energy';

// Add the HTTP endpoint for historical data
const HISTORY_API_ENDPOINT = 'http://172.18.7.88:5458/api/v1/energymonitoring/shiftwise_energy_history_by_date';
...
const useEnergyMonitoringBelStore = create((set, get) => ({
  ...
  connectWebSocket: (machineId) => {
    ...
    try {
      ...
      const wsUrl = `ws://172.18.7.88:5458/api/v1/energymonitoring/ws/live_data`;
  ...
  fetchFilteredHistoryData: async (machineId, startDate, endDate, parameterName) => {
    ...
    try {
      ...
      const baseUrl = `http://172.18.7.88:5458/api/v1/energymonitoring/filtered_history_data/${machineId}?start_date=${formattedStartDate}&end_date=${formattedEndDate}&column_name=${apiParamName}`;
