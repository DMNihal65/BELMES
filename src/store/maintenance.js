...
const SUPERVISOR_BASE_URL = 'http://172.16.0.229:8004/api/v1/maintainance';
const OPERATOR_BASE_URL = 'http://172.16.0.229:8004/api/v1/operator';
const MASTER_ORDER_URL = 'http://172.16.0.229:8004/api/v1/master-order';
