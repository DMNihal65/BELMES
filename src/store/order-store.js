...
const API_CONFIG = {
  ...
  endpoints: {
    ...
    allCompletionRecords: 'http://172.18.7.91:8008/api/v1/scheduling/all-completion-records',
    orderCompletionRecord: (orderId) => `http://172.18.7.91:8008/api/v1/scheduling/order-completion-record/${orderId}`
  }
};
