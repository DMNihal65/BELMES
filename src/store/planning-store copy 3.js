...
const usePlanningStore = create((set) => ({
  ...
  checkOrderCompletion: async (partNumber, productionOrder) => {
    ...
    try {
      ...
      const response = await fetch(`http://172.18.7.88:4479/api/v1/scheduling/check-order-completion-simple/${partNumber}/${productionOrder}`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json'
        },
  ...
  fetchDocumentVersions: async (documentId) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.88:4479/api/v1/document-management/documents/${documentId}/versions`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
        }
  ...
  uploadDocumentVersion: async (documentId, formData) => {
    try {
      ...
      // Use the correct API base URL (172.18.7.88:4479)
      const response = await fetch(`http://172.18.7.88:4479/api/v1/document-management/documents/${documentId}/versions`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
  ...
  downloadDocument: async (documentId, versionId = null) => {
    try {
      ...
      let downloadUrl = `http://172.18.7.88:4479/api/v1/document-management/documents/${documentId}/download`;
  ...
  fetchIpidDocumentsByPo: async (productionOrder) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.88:4479/api/v1/document-management/ipid/by-po/${productionOrder}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  fetchPartProductionPDC: async (partNumber, productionOrder) => {
    try {
      ...
      const url = new URL('http://172.18.7.88:4479/api/v1/scheduling/part-production-pdc11');
  ...
  fetchIpidStructure: async (productionOrder) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.88:4479/api/v1/document-management/ipid/structure/${productionOrder}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
        }
  ...
  fetchMachinePlanningByDateRange: async (startDate, endDate) => {
    try {
      ...
      const response = await fetch(
        `http://172.18.7.88:4479/api/v1/scheduling/machine-utilization/range?start_date=${formattedStartDate}&end_date=${formattedEndDate}`, 
        {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`,
            'accept': 'application/json'
  ...
  fetchPdcForCurrentJob: async (productionOrder) => {
    try {
      ...
      const response = await fetch(
        `http://172.18.7.88:4479/api/v1/scheduling/part-production-pdc11?part_number=${partNumber}&production_order=${productionOrder}`, 
        {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`,
            'accept': 'application/json'
  ...
  fetchProgramsByOrderId: async (orderId) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.88:4479/api/v1/toolsprograms/orderprograms/by-order/${orderId}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  addOrderProgram: async (programData) => {
    try {
      ...
      const response = await fetch('http://172.18.7.88:4479/api/v1/toolsprograms/orderprograms/', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json',
  ...
  updateOrderProgram: async (programId, programData) => {
    try {
      ...
      const response = await fetch(`http://172.18.7.88:4479/api/v1/toolsprograms/orderprograms/${programId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json',
