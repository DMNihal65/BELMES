...
const usePlanningStore = create((set) => ({
  ...
  searchOrders: async (productionOrder) => {
    set({ isLoading: true, error: null });
    try {
      const response = await fetch(`http://172.16.0.229:8004/api/v1/planning/search_order2?production_order=${productionOrder}`);
      const data = await response.json();
  ...
  fetchMPPDetails: async (productionOrder) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/documents/mpp/${productionOrder}`, {
        headers: {
  ...
  saveMPPDetails: async (mppData) => {
    ...
    try {
      ...
      const response = await fetch('http://172.16.0.229:8004/api/v1/mpp', {
        method: 'POST',
        headers: {
  ...
  fetchActiveParts: async () => {
    try {
      set({ isLoading: true });
      const response = await fetch('http://172.16.0.229:8004/api/v1/scheduling/active-parts');
      const data = await response.json();
  ...
  changePartStatus: async (productionOrder, newStatus) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/scheduling/set-part-status/${productionOrder}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  updateOperationDetails: async (partNumber, operationNumber, updateData) => {
    try {
      const response = await fetch(`http://172.16.0.229:8004/api/v1/planning/operations/${partNumber}/${operationNumber}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  fetchMppByIdentifier: async (productionOrder, operationNumber) => {
    try {
      const response = await fetch(`http://172.16.0.229:8004/api/v1/mpp/by-identifier?operation_number=${operationNumber}&production_order=${productionOrder}`, {
        headers: {
          'accept': 'application/json'
        }
      });
  ...
  downloadMppDocument: async (versionId) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/documents/${versionId}/download`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
        }
  ...
  fetchDocumentsByPartNumber: async (partNumber) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/document-management/documents/by-part-number-all/${partNumber}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
        }
  ...
  downloadLatestDocument: async (documentId) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/document-management/documents/${documentId}/download-latest`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'accept': 'application/json'
        }
    ...
    try {
      ...
      if (documentsData.mpp_document?.latest_version?.id) {
        ...
        const downloadResponse = await fetch(
          `http://172.16.0.229:8004/api/v1/document-management/documents/${documentsData.mpp_document.latest_version.id}/download-latest`, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`,
            'accept': '*/*'
          }
      ...
      const mppResponse = await fetch(
        `http://172.16.0.229:8004/api/v1/mpp/by-part/${partNumber}/${operation.operation_number}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  createOrFetchMPP: async (partNumber, operationNumber) => {
    try {
      const response = await fetch(`http://172.16.0.229:8004/api/v1/mpp/by-part/${partNumber}/${operationNumber}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  createOperation: async (partNumber, operationData) => {
    try {
      ...
      const response = await fetch('http://172.16.0.229:8004/api/v1/planning/operations', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json',
      ...
      try {
        const machinesResponse = await fetch(`http://172.16.0.229:8004/api/v1/planning/work-center-machines/${operationData.work_center_code}`, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`,
            'accept': 'application/json'
          }
      ...
      if (workCenterMachines && workCenterMachines.length > 0) {
        ...
        try {
          ...
          await fetch(`http://172.16.0.229:8004/api/v1/planning/operations/${partNumber}/${operationData.operation_number}`, {
            method: 'PUT',
            headers: {
              'Authorization': `Bearer ${localStorage.getItem('token')}`,
              'Content-Type': 'application/json',
  ...
  fetchWorkCenters: async () => {
    try {
      const response = await fetch('http://172.16.0.229:8004/api/v1/planning/work_centers', {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  uploadIpidDocument: async (file, productionOrder, operationNumber, documentName, description = '', versionNumber = '1', metadata = '{}') => {
    try {
      ...
      const response = await fetch('http://172.16.0.229:8004/api/v1/document-management/ipid/upload/', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  fetchMachineUtilization: async (month, year) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/scheduling/machine-utilization?month=${month}&year=${year}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  fetchMachineUtilizationByDateRange: async (startDate, endDate) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/scheduling/machine-utilization/range?start_date=${formattedStartDate}&end_date=${formattedEndDate}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  addOrderTool: async (toolData) => {
    try {
      ...
      const response = await fetch('http://172.16.0.229:8004/api/v1/toolsprograms/ordertools/', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json',
  ...
  updateOrderTool: async (toolId, toolData) => {
    try {
      ...
      const apiUrl = `http://172.16.0.229:8004/api/v1/toolsprograms/ordertools/${toolId}/`;
  ...
  deleteOrderTool: async (toolId) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/toolsprograms/ordertools/${toolId}/`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
  ...
  fetchToolsByOrderId: async (orderId) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/toolsprograms/ordertools/?order_id=${orderId}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  addOrderProgram: async (programData) => {
    try {
      ...
      const response = await fetch('http://172.16.0.229:8004/api/v1/toolsprograms/programs/', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json',
  ...
  fetchProgramsByOrderId: async (orderId) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/toolsprograms/programs/?order_id=${orderId}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  updateOrderProgram: async (programId, programData) => {
    try {
      ...
      const apiUrl = `http://172.16.0.229:8004/api/v1/toolsprograms/programs/${programId}/`;
      console.log(`Sending PUT request to: ${apiUrl}`);
  ...
  deleteOrderProgram: async (programId) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/toolsprograms/programs/${programId}/`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
  ...
  updateProgramVersion: async (programId, file, versionNumber) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/document-management/cnc-program/${programId}/versions`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
  ...
  fetchProgramVersions: async (documentId) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/document-management/cnc-program/${documentId}/versions`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  uploadCncProgram: async (formData) => {
    try {
      ...
      const response = await fetch('http://172.16.0.229:8004/api/v1/document-management/cnc-program/upload/', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  fetchPartProductionPDC: async (partNumber, productionOrder) => {
    try {
      ...
      const url = new URL('http://172.16.0.229:8004/api/v1/scheduling/part-production-pdc');
  ...
  getLatestOperationNumber: async (partNumber) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/planning/operations/latest/${partNumber}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  fetchEngineeringDrawings: async (partNumber) => {
    try {
      ...
      const response = await fetch(
        `http://172.16.0.229:8004/api/v1/document-management/documents/?page=1&page_size=10&part_number=${partNumber}`,
        {
          headers: {
            'Authorization': `Bearer ${token}`,
            'accept': 'application/json'
    ...
    try {
      ...
      if (!documentName) {
        try {
          ...
          const docDetailsResponse = await fetch(`http://172.16.0.229:8004/api/v1/document-management/documents/${documentId}`, {
            headers: {
              'Authorization': `Bearer ${token}`,
              'accept': 'application/json'
            }
  ...
  fetchPdcForCurrentJob: async (productionOrder) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/scheduling/part-production-pdc`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  fetchPdcData: async (productionOrder) => {
    try {
      const response = await fetch(`http://172.16.0.229:8004/api/v1/scheduling/part-production-pdc?production_order=${productionOrder}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
  ...
  fetchCncProgramDetails: async (partNumber) => {
    try {
      ...
      const response = await fetch(`http://172.16.0.229:8004/api/v1/document-management/cnc-program/by-part/${partNumber}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'accept': 'application/json'
        }
