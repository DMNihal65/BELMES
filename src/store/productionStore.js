...
const BASE_URL = 'http://172.16.0.229:1292/production_monitoring';
...
oeeData: {
  ...
  selectedShift: null
    ...
    fetchWorkCenters: async () => {
      try {
        const response = await axios.get('http://172.16.0.229:1292/api/v1/master-order/workcenters/?skip=0&limit=100');
