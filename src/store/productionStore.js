...
const BASE_URL = 'http://172.18.7.88:5458/production_monitoring';
...
const useProductionStore = create(
  devtools((set, get) => ({
    ...
    fetchWorkCenters: async () => {
      try {
        const response = await axios.get('http://172.18.7.88:5458/api/v1/master-order/workcenters/?skip=0&limit=100');
