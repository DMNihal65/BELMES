...
const BASE_URL = 'http://172.18.7.89:5469/production_monitoring';
...
oeeData: {
  ...
  selectedShift: null
    ...
    fetchWorkCenters: async () => {
      try {
        const response = await axios.get('http://172.18.7.89:5469/api/v1/master-order/workcenters/?skip=0&limit=100');
