...
const BASE_URL = 'http://172.18.100.67:4546/production_monitoring';
const WS_URL = 'ws://172.18.100.67:4546/production_monitoring/ws/live-status/';
...
oeeData: {
  ...
  selectedShift: null
    ...
    fetchWorkCenters: async () => {
      try {
        const response = await axios.get('http://172.18.100.67:4546/api/v1/master-order/workcenters/?skip=0&limit=100');
