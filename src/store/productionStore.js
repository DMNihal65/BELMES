...
const BASE_URL = 'http://172.18.7.88:4476/production_monitoring';
const WS_URL = 'ws://172.18.7.88:4476/production_monitoring/ws/live-status/';
...
const useProductionStore = create(
  devtools((set, get) => ({
    ...
    fetchWorkCenters: async () => {
      try {
        const response = await axios.get('http://172.18.7.88:4476/api/v1/master-order/workcenters/?skip=0&limit=100');
