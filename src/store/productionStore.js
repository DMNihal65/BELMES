...
const BASE_URL = 'http://127.0.0.1:8000/production_monitoring';
const WS_URL = 'ws://127.0.0.1:8000/production_monitoring/ws/live-status/';
...
oeeData: {
  ...
  selectedShift: null
    ...
    fetchWorkCenters: async () => {
      try {
        const response = await axios.get('http://127.0.0.1:8000/api/v1/master-order/workcenters/?skip=0&limit=100');
